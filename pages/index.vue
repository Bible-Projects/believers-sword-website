...
<template>
        ...
        <main class="main relative">
                        ...
                        <div class="w-full px-5">
                            <div class="scroll-revealed mx-auto max-w-[780px] text-center">
                                ...
                                <p
                                    ...
                                    Welcome to Believers Sword — a powerful yet simple Bible study app designed to deepen your walk with Christ. Whether you're just discovering it or have been using it for a while, Believers Sword equips you with intuitive tools and thoughtful features to help you engage with God’s Word more meaningfully.
                                </p>
                                ...
                                <ul class="mb-10 flex flex-wrap items-center justify-center gap-4 md:gap-5">
                                    <li>
                                        <a
                                            ...
                                            role="button"
                                        >
                                            <Icon name="ic:baseline-cloud-download" size="30" /> Installer ({{ tagName }})
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a
                                            ...
                                            :href="portableVersion.browser_download_url" 
                                            class="video-popup flex items-center gap-4 rounded-md bg-primary-color/[0.15] px-5 py-3 text-base font-medium text-white hover:bg-primary-color !hover:text-orange-500 md:px-7 md:py-[14px]"
                                            role="button">
                                            <Icon name="material-symbols:app-badging" size="30" /> Portable ({{ tagName }})
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <div class="max-w-[300px] mx-auto text-white">
                                    <small >
                                        This is only available for <b>Windows OS</b>, Coming soon for MAC and Linux
                                        By downloading, you agree to use it to study the bible heartily.
                                    </small>
                                </div>
                            </div>
                        </div>
                        <div class="w-full px-5">
                            <div class="scroll-revealed relative z-10 mx-auto max-w-[845px]">
                                ...
                                <div class="absolute -left-9 bottom-0 z-[-1]">
                                    <img src="@/assets/img/dots.svg" class="w-[120px] opacity-75" />
                                </div>
                    ...
                    <div class="grid grid-cols-1 gap-14 lg:grid-cols-2">
                        <div class="w-full">
                            <figure class="scroll-revealed max-w-[480px] mx-auto">
                                <NuxtImg format="webp" src="https://i.imgur.com/yIajRNN.jpeg"  alt="About image" quality="80" class="rounded-xl" />
                            </figure>
                        </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="tabs scroll-revealed">
                                <div class="tabs-content mt-4" id="tabs-panel-profile" tabindex="-1" role="tabpanel"
                                    ...
                                    <p>
                                        What started as a simple personal project for my portfolio eventually became something more meaningful. I initially built the app to showcase my development skills, gradually improving it over time by adding features like highlighting, dictionary support, and search functionality.
                                    </p>
                                </div>
                                ...
                                <div class="tabs-content mt-4" id="tabs-panel-vision" tabindex="-1" role="tabpanel"
                                    ...
                                    <p>
                                        As I was preparing to include it in my portfolio, a small group of users began to discover and use the app. While the number wasn't large, their presence encouraged me to keep improving it. Their interest showed me that even a small tool could make a difference.
                                    </p>
                                    <p>
                        ...
                        <div class="portfolio col-12 sm:col-6 lg:col-4">
                            <article class="group" data-filter="planning">
                                ...
                                <div class="pt-4">
                                    <h4 class="mb-2">
                                        <a href="javascript:void(0)"
                                            class="text-[1.5rem] leading-tight text-inherit">Digital Marketing</a>
                                    </h4>
                                    <p>
                                        Short description for the ones who look for something new.
                                        Awesome!
            ...
            <section id="blog" class="section-area" v-if="false">
                <div class="container">
                    <div class="scroll-revealed text-center max-w-[550px] mx-auto mb-12">
                        <h6 class="mb-2 block text-lg font-semibold !text-orange-500">Blog</h6>
                    ...
                    <div class="row">
                        <div class="scroll-revealed col-12 sm:col-6 lg:col-4">
                            <article class="group">
                                ...
                                <span class="block mt-6 w-full text-sm text-body-light-10 dark:text-body-dark-10">Joe
                                    Russell - 17 Agt 2024</span>
                                <h4 class="mb-6 mt-3 font-semibold text-[1.5rem]">
                                    <a href="javascript:void(0)" class="text-body-light-12 dark:text-body-dark-12">Make
                                        your team a Design driven company</a>
                                </h4>
                                <p>
                        ...
                        <div class="scroll-revealed col-12 sm:col-6 lg:col-4">
                            <article class="group">
                                ...
                                <span class="block mt-6 w-full text-sm text-body-light-10 dark:text-body-dark-10">Joe
                                    Russell - 17 Agt 2024</span>
                                <h4 class="mb-6 mt-3 font-semibold text-[1.5rem]">
                                    <a href="javascript:void(0)" class="text-body-light-12 dark:text-body-dark-12">The
                                        newest web framework that changed the world</a>
                                </h4>
                                <p>
                                    Lorem Ipsum is simply dummy text of the printing and
                                    typesetting industry. Lorem Ipsum has been the industry's
                        ...
                        <div class="scroll-revealed col-12 sm:col-6 lg:col-4">
                            <article class="group">
                                ...
                                <span class="block mt-6 w-full text-sm text-body-light-10 dark:text-body-dark-10">Joe
                                    Russell - 17 Agt 2024</span>
                                <h4 class="mb-6 mt-3 font-semibold text-[1.5rem]">
                                    <a href="javascript:void(0)" class="text-body-light-12 dark:text-body-dark-12">5
                                        ways to improve user retention for your startup</a>
                                </h4>
                                <p>
                                    Lorem Ipsum is simply dummy text of the printing and
                                    typesetting industry. Lorem Ipsum has been the industry's
