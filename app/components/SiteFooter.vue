<template>
    <footer class="bg-primary-dark-2 text-white">
            <div class="container py-20 lg:py-[100px]" v-if="false">
                <div class="row">
                    ...
                    <div class="col-12 -order-3 lg:col-4 lg:order-1">
                        <div class="w-full">
                            ...
                            <form action="#" method="POST" target="_blank" class="mt-8 flex">
                                ...
                                <button type="submit"
                                    class="inline-block py-3 w-[50px] rounded-md rounded-s-none text-center text-lg/none bg-primary !text-orange-500-color hover:bg-primary-light-10 dark:hover:bg-primary-dark-10 focus:bg-primary-light-10 dark:focus:bg-primary-dark-10">
                ...
                <div class="flex flex-wrap">
                    <div class="w-full md:w-1/2">
                        <div class="my-1">
                            <div class="flex flex-wrap justify-center gap-x-3 md:justify-start">
                                <a href="/privacy-policy" class="text-body-dark-11 hover:text-body-dark-12">
                                    Privacy
                                    Policy
                                </a>
                            </div>
                    ...
                    <div class="w-full md:w-1/2">
                        <div class="my-1 flex justify-center md:justify-end">
                            <p class="text-body-dark-11">
                                &#169; {{ new Date().getFullYear() }} Believers Sword by <a href="https://jenuel.dev">Jenuel.Dev</a>
                            </p>
                        </div>
                    </div>
                </div>
